            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="nombre" value="{{old('nombre')}}" placeholder="* Nombre" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <select class="form-control form-control-sm" name="almacen_tipo_id" required>
                            ...
                            @foreach ($tipos_almacenes as $tipo_almacen)
                                <option value="{{ $tipo_almacen->id }}">{{ $tipo_almacen->TipoAlmacen }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="d-grid gap-3 d-md-block">
                        <button type="submit" class="btn bg-gradient-primary btn-sm btn-accion"><i class="fas fa-fw fa-save"></i> Crear</button>
                    </div>
                </div>
                <div class="col-md-6">
