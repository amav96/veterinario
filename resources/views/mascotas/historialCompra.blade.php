    ...
    <div class="flex flex-column">
        <div class="card card-success">
            <div class="card-header flex flex-row items-center gap-4">
                ...
                <a  href="{{url('mascota/'.$mascota->id.'/historial-compra')}}" class="bg-yellow-600 p-2 rounded">
                    Historial de compra
                </a>
            </div>
        </div>  
...
<script type="module"  src="{{ mix('resources/js/mascota/historialCompra.js') }}"></script>
