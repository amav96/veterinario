        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="NombreServicio" name="NombreServicio" value="{{$servicio->Servicio}}" placeholder="* Nombre del servicio" required>
                </div>
                <div class="form-group">
                    <select class="form-control form-control-sm" id="Linea" name="Linea" required>
                        <option value="">* Linea...</option>
                        @foreach ($lineas as $lineas)
                        <option value="{{$lineas->id}}" @if ($lineas->id == $servicio->idLinea ){{'selected'}}@endif >{{$lineas->Linea}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="CostoServicio" name="CostoServicio" value="{{$servicio->CostoServicio}}" placeholder="* Costo del servicio (incluido impuestos)" onkeypress="return filterFloat(event,this);" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <select class="form-control form-control-sm" id="Categoria" name="Categoria" required>
                        ...
                        <option value="{{$categoria->id}}" @if ($categoria->id == $servicio->idCategoria ){{'selected'}}@endif >{{$categoria->Categoria}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    <select class="form-control form-control-sm" id="SubCategoria" name="SubCategoria">
                        ...
                        <option value="{{$SubCategoria->id}}" @if ($SubCategoria->id== $servicio->idSubCategoria ){{'selected'}}@endif >{{$SubCategoria->SubCategoria}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="PrecioServicio" name="PrecioServicio" value="{{$servicio->PrecioServicio}}" placeholder="* Precio del servicio (incluido impuestos)" onkeypress="return filterFloat(event,this);" required>
                </div>
                <div class="form-group">
                    <div class="custom-control custom-switch">
                      <input type="checkbox" class="custom-control-input" id="ExoneradoImpuestos" name="ExoneradoImpuestos"  @if ($servicio->ExoneradoImpuestos == true ){{'checked'}}@endif >
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="d-grid gap-3 d-md-block mb-3">
                    <button type="submit" class="btn bg-gradient-primary btn-sm"><i class="fas fa-save"></i>  Actualizar Servicio</button>         
